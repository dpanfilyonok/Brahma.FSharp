...
//             do! runCommand kernel <| fun kernelPrepare ->
//                 kernelPrepare
//                 <| Range1D(Settings.getValidGS size, Settings.wgSize)
//                 <| result
...
//         let kernel =
//             <@
//                 fun (range: Range1D) (array: 'a[]) (result: 'a[]) (zero: 'a) ->
...
//                 do! runCommand kernel <| fun kernelPrepare ->
//                     kernelPrepare
//                     <| Range1D(Settings.getValidGS array.Length, Settings.wgSize)
//                     <| array
//                     <| result
