...
let quotationTransformerTests =
    ...
    let quotationTransformerTest =
        ...
        let genTest testCase name expr expected =
            ...
            testCase name
            <| fun _ ->
                let actualKernelExpr, actualKernelMethods = Transformer.quotationTransformer expr []
        ...
        testList
            "transformer quotation system tests"
            [
                genTest
                    testCase
                    "Test 0"
