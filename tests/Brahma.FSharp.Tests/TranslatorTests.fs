...
//             let command =
//                 <@ fun (range: Range2D) (buf: array<int>) ->
...
//         let command = <@ fun (range: Range1D) (buf: array<int>) -> buf.[0] <- 0 @>
...
//         let command = <@ fun (range: Range1D) (buf: array<int>) -> buf.[0] <- 1 + 2 @>
...
//         let command = <@ fun (range: Range1D) (buf: array<int>) -> if 0 = 2 then buf.[0] <- 1 @>
...
//         let cArray1 = [| 1; 2; 3 |]
//         let command = <@ fun (range: Range1D) (buf: array<int>) -> buf.[0] <- cArray1.[1] @>
...
//         let cArray1 = [| 1; 2; 3 |]
//         let command = <@ fun (range: Range1D) (buf: array<int>) -> buf.[0] <- 1 + cArray1.[1] @>
...
//         let command =
//             <@ fun (range: Range1D) (xs: array<int>) ->
